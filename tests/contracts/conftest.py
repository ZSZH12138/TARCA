...
def make_valid_window_batch_kwargs(**overrides: object) -> dict[str, object]:
    ...
    kwargs: dict[str, object] = {
        ...
        "x_observed_mask": torch.ones((batch_size, history, 2), dtype=torch.bool),
        "y_observed_mask": torch.ones((batch_size, horizon, 1), dtype=torch.bool),
        ...
        "input_feature_names": ("signal_a", "signal_b"),
        "target_names": ("target",),
